...
class MockURLSession: URLSessionable {
    ...
    func dataTask(with url: URL, completionHandler: @escaping (Data?, URLResponse?, Error?) -> Void) -> URLSessionDataTask {
        let endpoint = APIEndpoints.getImage(with: "https://pixabay.com/ko/photos/%ea%b8%b0%eb%91%a5-%ec%bb%a4%ed%94%8c-%ec%82%ac%eb%9e%8c%eb%93%a4-%ea%b1%b4%ec%b6%95%eb%ac%bc-5747584/")
